...
class SchoolController extends BaseController
{
    ...
    public function getIndex()
    {
        ...
        }else
        {
            ...
            return view('admin.school.index', compact('schools', 'query'));
        }
    ...
    public function getSchoolDashboardIndex($schoolid = NULL)
    {
        ...
        return view('admin.school.layout.school_master',compact('schoolMoudelId', 'schoolid','studentsCountPage','schoolUserCount','schoolNewUser','school_action_user_today','school_action_user_yesterday','dataArray'));
    ...
    public function getSchoolHomeConfigIndex($schoolid = NULL)
    {
        ...
        return view('admin.school.layout.school_master',compact('schoolMoudelId', 'modules', 'schoolid', 'moduleTypes'));
    }
    ...
    public function getSchoolTopBannerAdvIndex($schoolid = NULL)
    {
        ...
        return view('admin.school.layout.school_master',compact('schoolMoudelId', 'schoolid', 'advs'));
    }
    ...
    public function getMultiStyleAdvIndex($schoolid = NULL)
    {
        ...
        return view('admin.school.layout.school_master', compact('schoolMoudelId', 'schoolid', 'advs_style1', 'advs_style2', 'advs_style3', 'advs_style4'));
    ...
    public function getSchoolMsgIndex($schoolid = NULL)
    {
        ...
        return view('admin.school.layout.school_master',compact('schoolMoudelId', 'schoolid', 'msg'));
