<div class="box box-primary">
    ...
    <div class="box-body">
        @if(!isset($query))
            ...
            @include('admin.circleschool.youliMsg.create_modal')
            @endif
        @endif
        <table class="table table-bordered table-hover" style="table-layout:fixed">
            ...
            @if(count($msg) > 0)
               ...
               <td>
                ...
                @include('admin.circleschool.youliMsg.update_modal')
...
<script>
    ...
    function isForbiddenAjax(id)
    {
        ...
        $.ajax({
            ...
            type : 'post',
            url : '/admin/circleschool/youliMsg/change-usestatus',
    ...
    {
        location.href = '/admin/circleschool/youliMsg/delete/' + mid;
    }
