<div class="modal fade" id="createModalStyle1" role="dialog" aria-hidden="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box box-primary">
                    <div class="box-body">
                        <form class="form" id="" action="{{ URL::to('admin/circleschool/'.$schoolid.'/adv/create-style1') }}" method="post" enctype="multipart/form-data">
