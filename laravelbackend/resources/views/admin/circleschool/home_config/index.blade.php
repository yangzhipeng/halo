<div class="box box-primary">
    ...
    <div class="box-body">
        @if(!isset($query))
            ...
            @include('admin.circleschool.home_config.create_modal')
        @endif
                ...
                @foreach($modules as $module)
                    <tr>
                        ...
                        <td>
                            ...
                            @include('admin.circleschool.home_config.update_modal')
...
<script>
    ...
    function isForbiddenAjax(id)
    {
        ...
        $.ajax({
            ...
            type : 'post',
            url : '/admin/circleschool/module/change-status',
    ...
    {
        location.href = '/admin/circleschool/homeconfig/delete/' + id;
    }
