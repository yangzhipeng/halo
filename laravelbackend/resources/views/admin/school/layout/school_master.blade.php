        ...
        function changeDayAjax()
        {
            ...
            if(day != '')
            {
                $.ajax({
                    ...
                    type : 'post',
                    url : '/admin/school/dashboard/changeday',
        ...
        function changeYearAjax()
        {
            ...
            if(year != '')
            {
                $.ajax({
                    ...
                    type : 'post',
                    url : '/admin/school/dashboard/changeyear',
        ...
        function selectedLi()
        {
            switch (schoolModelId){
                ...
                case 101:
                    ...
                    $("#home_confing_li_a").prop('href', '/admin/school/' + schoolId + '/homeconfig');
                    $("#adv_top_li_a").prop('href', '/admin/school/' + schoolId + '/top-adv');
                    $("#adv_mul_li_a").prop('href', '/admin/school/' + schoolId + '/mul-adv');
                    $("#youliMsg_li_a").prop('href','/admin/school/' + schoolId + '/youlimsg');
                    $("#bizcard_li_a").prop('href', '/admin/school/' + schoolId + '/bizcard');
                    $("#task_li_a").prop('href', '/admin/school/' + schoolId + '/task');
                    break;
                case 102:
                    $('#home_confing_li').prop('class', 'active');
                    $("#dashboard_li_a").prop('href', '/admin/school/' + schoolId + '/dashboard');
