        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    <div class="row">
                        <div class="col-xs-6">
                            <form action="/admin/school/{{ $schoolid }}/bizcard" method="get" class="">
...
<script>
    function setUniRecommend(schoolid, bid){
        window.location.href = "{{ URL::to('admin/school/') }}" + "/" + schoolid + "/bizcard/set-uni-recommend?bid=" + bid;
    }

    function removeUniRecommend(schoolid, bid){
        window.location.href = "{{ URL::to('admin/school/') }}" + "/" + schoolid + "/bizcard/remove-uni-recommend?bid=" + bid;
    }
</script>
