            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        @include('admin.school.adv.create_modal_style1')
                        ...
                        <table class="table table-bordered table-hover" style="table-layout:fixed">
                            ...
                            @if(count($advs_style1) > 0)
                                @foreach($advs_style1 as $adv)
                                    ...
                                    @include('admin.school.adv.update_modal')
                                @endforeach
                    ...
                    <div class="tab-pane" id="tab_2">
                        ...
                        @include('admin.school.adv.create_modal_style2')
                            ...
                            @foreach($advs_style2 as $adv_group)
                                <table id="{{ $adv_group[0] }}" class="table table-bordered table-hover" style="table-layout:fixed">
                                    ...
                                    @for ($i = 1; $i < count($adv_group); $i++)
                                        ...
                                        @include('admin.school.adv.update_modal_multi_style')
                                    @endfor
                                    </tbody>
                                </table>
                    ...
                    <div class="tab-pane" id="tab_3">
                        ...
                        @include('admin.school.adv.create_modal_style3')
                    ...
                    <div class="tab-pane" id="tab_4">
                        ...
                        @include('admin.school.adv.create_modal_style4')
...
@section('js')
    ...
    <script>
        ...
        {
            location.href = '/admin/school/adv/delete/' + id;
        }

        function delTable(id)
        {
            if(confirm("确定要清空数据吗？")) {
                location.href = '/admin/school/adv/delete-multi-style/' + id;
            }
        }
